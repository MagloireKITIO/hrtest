    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motivation', models.FileField(blank=True, null=True, upload_to='recruitment/motivation', validators=[recruitment.models.validate_pdf])),
                ...
                ('gender', models.CharField(choices=[('male', 'Monsieur'), ('female', 'Madame')], default='male', max_length=15, null=True, verbose_name='Gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recruitment_type', models.CharField(choices=[('INTERNAL', 'Internal'), ('EXTERNAL', 'External'), ('BOTH', 'Internal/External')], default='BOTH', help_text='Internal: Only @group-activa emails, Internal/External: All emails', max_length=10, verbose_name='Recruitment Type')),
                ...
                ('selectors', models.ManyToManyField(blank=True, help_text='Only these selectors can view and manage this recruitment if they are marked as selectors', related_name='recruitment_selections', to='employee.employee', verbose_name='Selectors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage_type', models.CharField(choices=[('initial', 'Initial'), ('applied', 'Applied'), ('test', 'Test'), ('interview', 'Interview'), ('cancelled', 'Cancelled'), ('hired', 'Hired'), ('selector', 'Demandeur')], default='interview', max_length=20)),
                ('sequence', models.IntegerField(default=0, null=True)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to='recruitment/motivation', validators=[recruitment.models.validate_pdf])),
                ('is_candidate', models.BooleanField(default=False)),
                ('recruitment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='motivation', to='recruitment.recruitment')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.FloatField(blank=True, null=True, verbose_name='Score')),
                ('motivation', models.TextField(blank=True, max_length=100, null=True, validators=[recruitment.models.validate_pdf])),
                ('address', models.TextField(blank=True, max_length=255, null=True, verbose_name='Address')),
                ('country', models.CharField(blank=True, max_length=30, null=True, verbose_name='Country')),
                ('dob', models.DateField(blank=True, null=True, verbose_name='Date of Birth')),
                ('state', models.CharField(blank=True, max_length=30, null=True, verbose_name='State')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Created At')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('is_validated', models.BooleanField(default=True, verbose_name='Validé')),
                ('validated_at', models.DateTimeField(auto_now_add=True)),
                ('comments', models.TextField(blank=True, null=True, verbose_name='Commentaires')),
                ('candidate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='selector_validations', to='recruitment.candidate')),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ('selector', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='candidate_validations', to='employee.employee')),
                ('stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='validations', to='recruitment.stage')),
            ],
            options={
                'verbose_name': 'Validation du demandeur',
                'verbose_name_plural': 'Validations des demandeurs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidate_rating', to='recruitment.candidate')),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidate_rating', to='employee.employee')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
            ],
            options={
