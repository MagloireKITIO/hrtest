...
from base.views import  CustomLoginView, blocked_accounts_view, login_audit_log_view, unblock_user
...
urlpatterns = [
    ...
    path('department-import/', views.import_departments, name='department-import'),
    path(
    ...
    path('job-position-delete/<int:obj_id>/', views.job_position_delete, name='job-position-delete'),
    ...
    path(
        'audit-log/',  
        login_audit_log_view,
        name='login-audit-log'
    ),

    path(
    'audit-log/export/',
    views.login_audit_log_export,
    name='login-audit-log-export'
    ),

    path('login/', CustomLoginView.as_view(), name='login'),
    
    path('blocked-accounts/', views.blocked_accounts_view, name='blocked-accounts'),
    path('unblock-user/<int:emp_id>/', views.unblock_user, name='unblock-user'),

    path('api/departments/<int:department_id>/position-count/', views.department_position_count, name='department-position-count'),
    path('api/departments/<int:department_id>/positions/', views.department_positions, name='department-positions'),
