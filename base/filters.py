...
from django_filters import CharFilter, DateFilter, FilterSet, NumberFilter, filters, DateTimeFilter, ChoiceFilter
...
from base.models import LoginAuditLog
...
class LoginAuditLogFilter(FilterSet):
    """
    Filter for LoginAuditLog 
    """
    STATUS_CHOICES = (
        ('', '---'),
        (True, 'Success'),
    ...
    class Meta:
        model = LoginAuditLog
        fields = ['success', 'date_from', 'date_to']
