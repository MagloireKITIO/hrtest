    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_selector', models.BooleanField(default=False, help_text='If selected, this employee will only see assigned recruitments', verbose_name='Is Selector')),
                ('needs_password_change', models.BooleanField(default=True, help_text='If True, user must change password on next login')),
                ('company_id', models.ForeignKey(blank=True, help_text='Employee will only see data from this company. Leave blank for all companies access.', null=True, on_delete=django.db.models.deletion.PROTECT, to='base.company', verbose_name='Company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_id', models.ManyToManyField(related_name='company_employees', to='base.company', verbose_name='Companies')),
